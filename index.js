...
window.addEventListener("wheel", (event) => {
    ...
    // if(is_function_area && now_function_area == 3) {
    ...
    if (is_function_area) {
        ...
        if (now_function_area == 6) {
            isTransitioning = true;
            g2_p1.style.opacity = '0.6';
            g2_p1.style.top = '80px';
...
window.addEventListener("scroll", (event) => {
    ...
    if (scrollTop >= example1.offsetTop - snapThreshold - 100 && scrollTop < example1.offsetTop) {
    ...
    if (scrollTop >= graph1.offsetTop - 150 && scrollTop < graph1.offsetTop - 100 && into_f3 == false) {
    ...
    if (scrollTop >= graph2.offsetTop - 150 && scrollTop < graph2.offsetTop - 100 && into_f4 == false) {
        into_f4 = true;
